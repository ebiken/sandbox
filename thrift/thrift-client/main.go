...
import (
    ...
    // Import interface package generated by Thrift
    "github.com/ebiken/sandbox/thrift/gen-go/mythrift/demo"
)
...
func main() {
    ...
    model := demo.Article{1, "Send from Golang Thrift Client", "Hello World!", "Golang"}
    client.Put(&model)
